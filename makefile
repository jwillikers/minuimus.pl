...
deps:
	apt-get install qpdf jpegoptim optipng advancecomp webp unrar zip gifsicle p7zip-full poppler-utils libjpeg-progs imagemagick-6.q16 mupdf-tools brotli
